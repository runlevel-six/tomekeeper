...
```
tomekeeper v1.0.1 (a1b2c3d) built 2026-08-16T23:00:03Z go1.26.5 linux/amd64
```
...
string as the git tag and the image tag for a release (`v1.0.1`), and a description
of the distance from the last one otherwise (`v1.0.1-12-gfccf5ba`). The publish
