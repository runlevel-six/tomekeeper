...
```
tomekeeper v0.6.0 (a1b2c3d) built 2026-08-16T23:00:03Z go1.26.5 linux/amd64
```
...
string as the git tag and the image tag for a release (`v0.6.0`), and a description
of the distance from the last one otherwise (`v0.6.0-12-gfccf5ba`). The publish
