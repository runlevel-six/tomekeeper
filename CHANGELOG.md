...
carries **the same string**: `ghcr.io/runlevel-six/tomekeeper:v0.17.1` is the tag
`v0.17.1`, and `tome version` inside it says `v0.17.1`. One identifier, everywhere,
...
[Unreleased]: https://github.com/runlevel-six/tomekeeper/compare/v0.17.1...HEAD
