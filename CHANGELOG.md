...
carries **the same string**: `ghcr.io/runlevel-six/tomekeeper:v0.16.0` is the tag
`v0.16.0`, and `tome version` inside it says `v0.16.0`. One identifier, everywhere,
...
[Unreleased]: https://github.com/runlevel-six/tomekeeper/compare/v0.16.0...HEAD
